...
MODEL_FILE_NAME = "pipe_ball_320_v2.mud"
MODEL_BINARY_FILE_NAME = "pipe_ball_320_v2.cvimodel"
_BUNDLED_MODEL_PATH = os.path.join(
    os.path.dirname(os.path.abspath(__file__)),
    MODEL_FILE_NAME,
)
_PERSISTENT_MODEL_PATH = (
    "/root/models/pipe_ball_320_v2/pipe_ball_320_v2.mud"
)
MODEL_PATH = (
    _BUNDLED_MODEL_PATH
...
def main():
    ...
    try:
        ...
        while not app.need_exit():
            frame = cam.read()
            roi = frame.crop(ROI_X, ROI_Y, ROI_WIDTH, ROI_HEIGHT)
