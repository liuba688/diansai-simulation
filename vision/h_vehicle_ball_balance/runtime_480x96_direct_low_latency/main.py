...
from task4_center_hold_control import (
    BallTaskController,
    CENTER_0_PX,
...
def main():
    ...
    print(
        "Task 4 center-hold direct X42S controller started "
        ...
        while not app.need_exit():
            ...
            if now - last_log_time >= LOG_INTERVAL_SECONDS:
                ...
                print(
                    ...
                    "ack={} err={} rej={} rec={}/{}ms peak={:.1f}mm "
                    "spec={} fault={} fps={:.1f}".format(
                        control_snapshot["state"],
                        control_snapshot["elapsed_s"],
                        raw_x,
                        control_snapshot["position_mm"],
                        ...
                        control_snapshot["recovery_count"],
                        int(
                            round(
                                1000.0
                                * control_snapshot[
                        ...
                        control_snapshot["peak_abs_error_mm"],
                        0 if control_snapshot["out_of_spec"] else 1,
                        (
                            "-"
