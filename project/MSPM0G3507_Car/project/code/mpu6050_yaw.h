...
/*
 * MPU6050 / MPU6500 Yaw Angle Module
 *
 * 硬件: MPU6050 (WHO_AM_I=0x68) 或 MPU6500 兼容芯片
 *       (WHO_AM_I=0x70), I2C 地址 0x68, SCL=PA1, SDA=PA0
 * Yaw 独立梯形积分。
...
/*
 * Module- and installation-specific calibration.
