...
/* 2024 H3: original unfiltered line-follow controller. */

#include "zf_common_typedef.h"
#include "line_sensor.h"

#define LINE_FOLLOW_STRAIGHT_RPM             (80.0f)
#define LINE_FOLLOW_MIN_CURVE_RPM            (40.0f)
...
#define LINE_FOLLOW_SHARP_OUTER_RPM          (38.0f)
#define LINE_FOLLOW_SHARP_INNER_RPM          (-12.0f)

#define LINE_FOLLOW_LOST_FORWARD_TICKS       (15)
#define LINE_FOLLOW_LOST_FORWARD_RPM         (32.0f)
